...
/**
 * Value 注解语法类 第一步：在属性上添加注解Value注入参数 第二步：把Value注解修饰的类添加到Spring的IOC容器中；
 ...
 * 三、不支持复杂的数据结构，提示错误和第一条相同：IllegalArgumentException: Could not resolve
 * placeholder 'itdragon.abilities' in value "${itdragon.abilities}"
 */
@Component
@Validated
