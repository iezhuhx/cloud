 ...
 *@Author iechenyb<br>
 *@Desc 类描述<br>
 *@CreateTime 2020年5月25日 下午12:09:39
 */
public class WorkflowConstants {
    ...
    /** 动态流程图颜色定义 **/
    public static final Color COLOR_NORMAL = new Color(0, 205, 0);//历史活动的任务及路线 绿色
    public static final Color COLOR_CURRENT = new Color(255, 0, 0);//当前活动的任务颜色
