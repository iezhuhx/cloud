package com.cyb.bean.response.constant;
...
public class ResponseStatus {
	...
	public final  static String SUCCESS = "0";//执行成功
	public final  static String FAIL = "1";//执行失败
	public final  static  String NO_PERMISSION = "2";//没有权限
	...
	private static Map<String,String> messageMap = new HashMap<String, String>();//模板编写
    //初始化状态码与文字说明
    static {
        messageMap.put("0", "");
